...
--
-- Host: localhost:3306
-- Waktu pembuatan: 08 Bulan Mei 2024 pada 06.35
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
CREATE TABLE `categories` (
  ...
  `maincategory_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `profiles` (
  ...
  `age` enum('18-25','26-35','36-45','45+') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `skin_type_face` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hair_issue` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `skin_type_body` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `allergy_history` json DEFAULT NULL,
  `preferred_products` json DEFAULT NULL,
  `avoided_products` json DEFAULT NULL,
  `specific_needs` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 2, 'Laki-laki', '18-25', 'kering', 'kering', 'kering', '[\"tidak_ada_alergi\"]', '[\"bahan_alami\", \"pewangi\"]', '[\"vegan\", \"paraben\", \"sls\"]', '[\"meratakan_warna_kulit\", \"menghilangkan_jerawat\", \"menghidrasi\", \"perlindungan_matahari\", \"menghilangkan_noda_hitam\"]', '2024-02-28 14:46:36', '2024-02-28 16:05:39'),
