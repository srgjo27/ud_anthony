...
<script type="text/javascript" src="{{ asset('admin/files/assets/pages/form-validation/form-validation.js') }}">
</script> --}}

<!-- script of select 2 -->
<script type="text/javascript" src="{{ asset('admin/files/bower_components/select2/js/select2.full.min.js') }}">
</script>
<script type="text/javascript"
    src="{{ asset('admin/files/bower_components/bootstrap-multiselect/js/bootstrap-multiselect.js') }}"></script>
<script type="text/javascript" src="{{ asset('admin/files/bower_components/multiselect/js/jquery.multi-select.js') }}">
</script>
<script type="text/javascript" src="{{ asset('admin/files/assets/js/jquery.quicksearch.js') }}"></script>
<script type="text/javascript" src="{{ asset('admin/files/assets/pages/advance-elements/select2-custom.js') }}">
</script>

<!-- script of notification -->
